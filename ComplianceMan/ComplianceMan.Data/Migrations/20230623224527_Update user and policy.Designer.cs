...
namespace ComplianceMan.Data.Migrations
{
    ...
    [Migration("20230623224527_Update user and policy")]
    partial class Updateuserandpolicy
    {
            ...
            modelBuilder.Entity("ComplianceMan.Data.Entity.UserPolicyDTO", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserPolicyId = 1,
                            AcceptanceDate = new DateTime(2023, 6, 24, 4, 45, 27, 146, DateTimeKind.Local).AddTicks(8998),
                            PolicyId = 1,
                            UserId = 1
                        },
                        new
                        {
                            UserPolicyId = 2,
                            AcceptanceDate = new DateTime(2023, 6, 24, 4, 45, 27, 146, DateTimeKind.Local).AddTicks(9015),
                            PolicyId = 2,
                            UserId = 2
                        });
                });
