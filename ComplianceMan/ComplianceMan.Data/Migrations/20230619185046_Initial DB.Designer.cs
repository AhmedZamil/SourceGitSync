...
namespace ComplianceMan.Data.Migrations
{
    ...
    [Migration("20230619185046_Initial DB")]
            ...
            modelBuilder.Entity("ComplianceMan.Data.Entity.UserPolicyDTO", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserPolicyId = 1,
                            AcceptanceDate = new DateTime(2023, 6, 20, 0, 50, 45, 973, DateTimeKind.Local).AddTicks(945),
                            PolicyId = 1,
                            UserId = 1
                        },
                        new
                        {
                            UserPolicyId = 2,
                            AcceptanceDate = new DateTime(2023, 6, 20, 0, 50, 45, 973, DateTimeKind.Local).AddTicks(956),
                            PolicyId = 2,
                            UserId = 2
                        });
                });
