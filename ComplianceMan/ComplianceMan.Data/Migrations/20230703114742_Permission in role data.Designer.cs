...
namespace ComplianceMan.Data.Migrations
{
    ...
    [Migration("20230703114742_Permission in role data")]
    partial class Permissioninroledata
    {
            ...
            modelBuilder.Entity("ComplianceMan.Data.Entity.UserPolicyDTO", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserPolicyId = 1,
                            AcceptanceDate = new DateTime(2023, 7, 3, 17, 47, 41, 783, DateTimeKind.Local).AddTicks(651),
                            PolicyId = 1,
                            UserId = 1
                        },
                        new
                        {
                            UserPolicyId = 2,
                            AcceptanceDate = new DateTime(2023, 7, 3, 17, 47, 41, 783, DateTimeKind.Local).AddTicks(665),
                            PolicyId = 2,
                            UserId = 2
                        });
                });
